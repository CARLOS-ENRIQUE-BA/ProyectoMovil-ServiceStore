  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ alignItems: 'center' }}>
        <Text style={styles.title}>Mecanica Automotriz</Text>
        <View style={styles.serviceContainer}>
          <TouchableOpacity onPress={handlePress}>
            <Image source={require('../assets/img/mechanical/img1.jpg')} style={styles.imagePlaceholder} />
          </TouchableOpacity>
          <TouchableOpacity onPress={handlePress}>
          ...
          />
          <Text>Mecánica Automotriz Gómez, tu aliado confiable para el mantenimiento de tu vehículo</Text>
        </View>
        <View style={styles.serviceContainer}>
          <TouchableOpacity onPress={handlePress}>
            <Image source={require('../assets/img/mechanical/img2.jpg')} style={styles.imagePlaceholder} />
          </TouchableOpacity>
          <TouchableOpacity onPress={handlePress}>
            <Text style={styles.serviceTitle}>Servicio</Text>
          </TouchableOpacity>
          ...
          />
          <Text>Taller Mecánico Rodríguez, especialistas en diagnóstico y reparación automotriz</Text>
        </View>
        <View style={styles.serviceContainer}>
          <TouchableOpacity onPress={handlePress}>
          ...
          />
          <Text>Servicio Técnico Automotriz Ramírez, calidad y precisión en cada reparación</Text>
        </View>
      </ScrollView>
