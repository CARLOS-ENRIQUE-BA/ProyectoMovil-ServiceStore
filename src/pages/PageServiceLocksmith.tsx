    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ alignItems: 'center' }}>
        ...
        <MoleculeServiceCard
          ...
          subTitle="Cerrajería Hernández, la seguridad en manos expertas."
          onPress={handlePress}
        ...
        <MoleculeServiceCard
          imageSource={require('../assets/img/locksmith/img2.jpg')}
          serviceTitle="Servicio"
          subTitle="Servicios de Cerrajería Pérez, abriendo puertas con confianza"
          onPress={handlePress}
        ...
        <MoleculeServiceCard
          imageSource={require('../assets/img/locksmith/img3.jpg')}
          serviceTitle="Servicio"
          subTitle="Cerrajería Martínez, tu mejor opción para soluciones rápidas y seguras"
          onPress={handlePress}
