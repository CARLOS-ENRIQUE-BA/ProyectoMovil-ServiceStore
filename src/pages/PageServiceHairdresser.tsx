  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={{ alignItems: 'center' }}>
        ...
        <MoleculeServiceCard
          imageSource={require('../assets/img/hairdresser/img1.jpg')}
          serviceTitle="Servicio"
          subTitle="Peluquería Estilo López, transformando tu look con cada corte"
          onPress={handlePress}
        ...
        <MoleculeServiceCard
          imageSource={require('../assets/img/hairdresser/img2.jpg')}
          serviceTitle="Servicio"
          subTitle="Salón de Belleza Pérez, expertos en cortes y peinados a la moda"
          onPress={handlePress}
        ...
        <MoleculeServiceCard
          ...
          serviceTitle="Servicio"
          subTitle="Estilistas Gutiérrez, tu mejor elección para un cambio de imagen perfecto"
          onPress={handlePress}
